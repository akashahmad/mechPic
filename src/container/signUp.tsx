        ...
        >
            ...
            <Card>
                <Form form={form} name="Login " onFinish={onFinish}>
                    ...
                    >
                        <Input className="rounded-3xl font-weight-bold" placeholder="user name" />
                    </Form.Item>
                    <Form.Item
                        label=""
                        name="email"
                    ...
                    >
                        <Input className="rounded-3xl font-weight-bold" placeholder="Country" />
                    </Form.Item>
                    <Row className="justify-between">
                        <Col
                            xs={11}
                    ...
                    <Form.Item name="shareImage" valuePropName="checked">
                        <Checkbox>
                            <p>
                                ...
                                permission to share freely and that they agree that their images can
                                be freely shared with attribution.
                            </p>
                        </Checkbox>
                    </Form.Item>
